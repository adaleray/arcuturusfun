...
const words = ['çikolata', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek', 'kırmızı arabanın yanındaki mavi arabanın önündeki sarı arabanın yanindaki eflatun araba', 'priaposcode'];
...
exports.help = {
  name: 'yazan-kazanır',
  category: "eğlence",
  description: 'Botun verdiği kelimeyi ilk yazan kazanır oyunu! Priapos Code',
